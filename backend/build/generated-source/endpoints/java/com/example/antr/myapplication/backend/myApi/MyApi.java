...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetMessages getMessages(java.lang.Long lastMessageTime) throws java.io.IOException {
    GetMessages result = new GetMessages(lastMessageTime);
    initialize(result);
    return result;
  }

  public class GetMessages extends MyApiRequest<com.example.antr.myapplication.backend.myApi.model.ChatMessageCollection> {

    private static final String REST_PATH = "chatmessagecollection/{lastMessageTime}";
     ...
     * @since 1.13
     */
    protected GetMessages(java.lang.Long lastMessageTime) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.antr.myapplication.backend.myApi.model.ChatMessageCollection.class);
      this.lastMessageTime = com.google.api.client.util.Preconditions.checkNotNull(lastMessageTime, "Required parameter lastMessageTime must be specified.");
    }
     ...
     */
    public java.lang.Long getLastMessageTime() {
      return lastMessageTime;
    }

    public GetMessages setLastMessageTime(java.lang.Long lastMessageTime) {
   ...
   *
   * @param content the {@link com.example.antr.myapplication.backend.myApi.model.ChatMessage}
   * @return the request
   */
  public SayHi sayHi(com.example.antr.myapplication.backend.myApi.model.ChatMessage content) throws java.io.IOException {
    SayHi result = new SayHi(content);
    initialize(result);
    return result;
  }

  public class SayHi extends MyApiRequest<com.example.antr.myapplication.backend.myApi.model.ChatMessage> {
     ...
     * @since 1.13
     */
    protected SayHi(com.example.antr.myapplication.backend.myApi.model.ChatMessage content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.antr.myapplication.backend.myApi.model.ChatMessage.class);
    }
